...
const CATEGORY_LIST = [
  ...
  { name: 'Cosmétiques · Cosmetics',                slug: 'cosmetiques',      emoji: '💄', order: 10 },
  { name: 'Emballages · Packaging',                 slug: 'emballages',       emoji: '📦', order: 11 },
  { name: 'Accessoires Maison · Home Accessories',  slug: 'maison',           emoji: '🏠', order: 12 },
  { name: 'Accessoires Cuisine · Kitchen',          slug: 'cuisine',          emoji: '🍳', order: 13 },
  { name: 'Accessoires Bébé · Baby',                slug: 'bebe',             emoji: '🍼', order: 14 },
  { name: 'Accessoires Téléphone · Phone Accessories', slug: 'telephone',     emoji: '📱', order: 15 },
  { name: 'Sport & Fitness',                        slug: 'sport-fitness',    emoji: '🏋️', order: 16 },
  { name: 'Produits Animaux · Pet Products',        slug: 'animaux',          emoji: '🐾', order: 17 },
  { name: 'Tenues de Sport · Sportswear',           slug: 'tenues-sport',     emoji: '👟', order: 18 },
  { name: 'Électronique · Electronics',             slug: 'electronique',     emoji: '🔌', order: 19 },
  { name: 'Décoration · Home Decor',                slug: 'decoration',       emoji: '🪴', order: 20 },
  { name: 'Lingerie',                               slug: 'lingerie',         emoji: '🩱', order: 21 },
  { name: 'Transitaires & Logistique · Freight',    slug: 'logistique',       emoji: '🚢', order: 22 },
  { name: 'Packaging · Emballage',                  slug: 'packaging',        emoji: '🎁', order: 23 },
]
